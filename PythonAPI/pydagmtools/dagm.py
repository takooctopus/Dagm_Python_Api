...
# 我们项目写的DAGM数据库的调用API，当然文件结构可能有些改动，但是为了适配我们项目的使用
# 这一个是读取annotation的json文件并且创建结构使用的


# 下面是api的具体结构
#
# dagm - dagm的api类，读取标签文件并准备结构
# decodeMask
# encodeMask
# getAnnIds
# getCatIds
...
class DAGM:
    def __init__(self, annotation_file=None):
        ...
        if not annotation_file == None:
            print("\033[0;36m " + "加载标签文件进入内存:" + "\033[0m" + "{}".format(annotation_file))
            tic = time.time()
    ...
    def createIndex(self):
        # 创建序列id
        print("\033[0;36m " + "正在创建序列index" + "\033[0m" + "{}".format("....."))
        anns, cats, imgs = {}, {}, {}
